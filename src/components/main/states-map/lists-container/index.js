  ...
  render() {
    ...
    const spinner = (
      <Spinner
        name="circle"
        fadeIn="quarter"
        overrideSpinnerClassName="loading-spinner"
      />
    );
    ...
    return (
      <div className={`lists-container ${this.props.className}`}>
        <div className="btn-wrap">
          <button
            type="button"
            className={group === 'senate' ? 'active' : ''}
            onClick={e => this.handleClick('senate')}
          >
            Senate
          </button>
          <button
            type="button"
            className={group === 'house' ? 'active' : ''}
            onClick={e => this.handleClick('house')}
          >
            House
          </button>
        </div>
        {this.props.loading ? (
          ...
          <CandidatesList group={group} candidates={this.props[group]} />
        )}
      </div>
    );
  }
